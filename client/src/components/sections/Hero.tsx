...
const carouselImages = [
  "https://images.unsplash.com/photo-1576670159805-2c13a4fe04f2",
  "https://images.unsplash.com/photo-1581595220892-b0739db3ba8c",
  "https://images.unsplash.com/photo-1581597090663-9ceaa45a226d",
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pr-8" data-aos="fade-right">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <a
                href="https://archive.org/download/healthcare-explainer-toolkit-free/Healthcare%20Explainer%20Toolkit_free.mp4"
                className="border-primary text-primary hover:bg-primary/10 inline-flex items-center justify-center px-4 py-2 border rounded-lg text-lg"
              >
                Watch Demo
              </a>
            </div>
            ...
            <div className="bg-card rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="p-6 max-h-[400px] overflow-y-auto">
                <div className="space-y-5">
                  ...
                  <div className="bg-muted p-4 rounded-lg">
                    <p className="font-medium mb-2">Brain CT Auto-Report:</p>
                    <img src="/images/BrainAutoReport.png" alt="Brain Auto Report" className="w-full rounded-lg shadow-md" />
                  </div>
                </div>
              </div>
            </div>
